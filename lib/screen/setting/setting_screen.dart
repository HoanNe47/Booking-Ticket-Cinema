          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text('Liên hệ Email'.tr),
                subtitle: const Text('support@example.com'),
                onTap: () => _launchURL('mailto:hoantran2003okay@gmail.com'),
              ),

              // Facebook Support
              ListTile(
                leading: const Icon(Icons.facebook, color: Colors.blue),
                title: Text('Facebook Hỗ trợ'.tr),
                subtitle: const Text('Message us on Facebook'),
                onTap: () => _launchURL('https://www.facebook.com/dungne4763'),
              ),

              // Live Chat Support
              ListTile(
                leading: const Icon(Icons.chat_bubble, color: Colors.green),
                title: Text('Chat trực tuyến'.tr),
